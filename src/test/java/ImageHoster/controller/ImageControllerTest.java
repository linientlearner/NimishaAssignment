...
public class ImageControllerTest {
    ...
    public void getUserImages() throws Exception {
        ...
        userProfile.setId(1);
        userProfile.setEmailAddress("nimijsr@gmail.com");
        userProfile.setFullName("NIMISHA VARMA);
        userProfile.setMobileNumber("8052237937");
        user.setProfile(userProfile);
        user.setId(1);
        user.setUsername("nimi");
        user.setPassword("nidhi@tul93");
    ...
    public void uploadImageWithGetRequest() throws Exception {
        ...
        UserProfile userProfile = new UserProfile();
        userProfile.setId(1);
        userProfile.setEmailAddress("nimi@gmail.com");
        userProfile.setFullName("Nimisha Varma");
        userProfile.setMobileNumber("9680714120");
        user.setProfile(userProfile);
        user.setId(1);
        user.setUsername("nimi");
        user.setPassword("nidhi@tul93");
    ...
    public void editImageWithNonOwnerOfTheImage() throws Exception {
        ...
        userProfile.setId(2);
       userProfile.setEmailAddress("vartika@gmail.com");
        userProfile.setFullName("vartika");
        userProfile.setMobileNumber("9919003456");
        user.setProfile(userProfile1);
        user.setId(2);
        user.setUsername("vishu");
        user.setPassword("vishu@13");
